...
namespace Fireteam.Controllers
{
    public class PlatformsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Created,LastModified,IsDeleted")] Platform platform)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Created,LastModified,IsDeleted")] Platform platform)
        {
            if (id != platform.ID)
            {
                return NotFound();
