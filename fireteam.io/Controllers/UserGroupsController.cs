...
namespace Fireteam.Controllers
{
    public class UserGroupsController : Controller
    {
        ...
        {
            var fireteamDbContext = _context.UserGroups.Include(u => u.Group).Include(u => u.User);
        ...
        public async Task<IActionResult> Create([Bind("ID,UserID,GroupID,Created,LastModified,IsDeleted")] UserGroup userGroup)
        {
            ...
            ViewData["GroupID"] = new SelectList(_context.Groups, "ID", "ID", userGroup.GroupID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,UserID,GroupID,Created,LastModified,IsDeleted")] UserGroup userGroup)
        {
            if (id != userGroup.ID)
            {
                return NotFound();
