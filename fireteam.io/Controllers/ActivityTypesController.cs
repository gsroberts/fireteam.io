...
namespace fireteam.io.Controllers
{
    public class ActivityTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Description,Created,LastModified,IsDeleted")] ActivityType activityType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Description,Created,LastModified,IsDeleted")] ActivityType activityType)
        {
